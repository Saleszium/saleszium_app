const generateEmailHtml = (confirmationUrl) => `
        ...
        <div style="max-width: 400px;"><img alt="Saleszium Logo" height="auto" src="https://cloudfilesdm.com/postcards/image-1736835666846.png" style="display: block; height: auto; border: 0; width: 100%;" title="" width="400"/></div>
        </div>
        </td>
        </tr>
        </table>
