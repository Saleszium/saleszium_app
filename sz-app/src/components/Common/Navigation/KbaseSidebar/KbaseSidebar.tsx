...
export default function KbaseSidebar({
  ...
  const { isKnowledgeBaseOpen } = useSidebar();
  ...
  const BASE_PATH = `/${currentRole}/knowledge-base`;
      ...
      submenu: [
        {
          id: "all",
          label: "All",
          path: `${BASE_PATH}/filter/all`,
        },
        {
          id: "published",
          label: "Published",
          path: `${BASE_PATH}/filter/published`,
        },
        {
          id: "draft",
          label: "Draft",
          path: `${BASE_PATH}/filter/draft`,
        },
      ],
    },
    // {
    ...
    <div className="flex h-[calc(100vh-var(--header-height)-1rem)] w-full overflow-hidden bg-sidebar">
      <div
        className={cn("flex flex-col transition-all duration-300 ease-in-out", {
          "w-56": isKnowledgeBaseOpen,
          "w-0": !isKnowledgeBaseOpen,
        })}
      >
